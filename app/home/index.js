//user interface for viewing and managing habits
import {
  StyleSheet,
  Text,
  View,
...
import { useRouter } from "expo-router"; // Used for navigation within the app
...
const index = () => {
  ...
  const fetchHabits = async () => {
    try {
      const response = await axios.get("http://10.12.23.60:3000/habitslist");
