...
const app = express();
const port = 3000; //Defining the port on which the server will listen for incoming requests.
...
mongoose
  .connect("mongodb+srv://kavya:kavya@cluster0.fewv2sw.mongodb.net/") //establishing connection to MongoDB
  .then(() => {
